...
differences. `scripts/run-w3c-jsonld-tests.sh` runs 154 to-RDF vectors,
including default direction omission, `i18n-datatype`, and compound-literal
output. `scripts/run-w3c-jsonld-compact-tests.sh` runs 95 semantic compaction
...
`scripts/run-w3c-jsonld-compact-tests.sh` runs 95 local-context compaction
