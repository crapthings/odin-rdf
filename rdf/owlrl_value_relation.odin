...
// RDF 1.1 language literals, boolean, binary, anyURI, and dateTime/
// dateTimeStamp. It is intentionally silent for XMLLiteral and datatype
// families whose complete value mappings are not yet represented.
