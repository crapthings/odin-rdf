...
c001 c002 c003 c005 c012 c013 c017 c018 c019 c020 c023 c024 c025 c027 js09 li01 li02 li03 li04 li05 m001 m002 m005 m012 m013 m014 m017 m018 m019 n006 n007 n008 n009 p003 pr04 tn01 tn02 tn03
'
...
for case_id in $cases; do
  ...
  case "$case_id" in
    0045|0062|0066|0111|c025) base="--base https://w3c.github.io/json-ld-api/tests/compact/$case_id-in.jsonld" ;;
  esac
