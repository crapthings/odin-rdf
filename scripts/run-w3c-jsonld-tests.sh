...
e003 e004 e008 e014 e015 e016 e023 e027 e036 e038 e043 e050 e061
'
...
for case_id in $cases; do
  ...
  case "$case_id" in
    ...
    di*|e003|e004|e008|e014|e015|e016|e023|e027|e036|e038|e043|e050|e061) semantic_compare=true ;;
  esac
  run_ok=true
